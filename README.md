...
2. 処理オプションを選ぶ(最適化、固定サイズの除去、装飾/意味あり)
3. 色一覧から、テーマに追従させたい色をクリックしてcurrentColor化する
4. 3背景のプレビューで見え方を確かめ、整形済みコードをコピーする

### 変換の内訳

| 処理               | 内容                                                                                         |
| :----------------- | :------------------------------------------------------------------------------------------- |
| 最適化             | コメント、metadata、inkscape / sodipodi等のエディタ名前空間を除去し、パスの小数を2桁に丸める |
